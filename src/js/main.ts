...
window.api.receive("fromUploadPDF", (f: FSFile, ITNr: string) => {
    const device = getDevice(ITNr)[0];
    ...
    PDF({ITNr: ITNr, method: "POST", SessionID: key, username: username, uploadOwn: true, file: f}).then(res =>{
